...
{
    pybind11::class_<atcg::AttachedDiffPathtracingIntegrator,
                     atcg::Integrator,
                     atcg::ref_ptr<atcg::AttachedDiffPathtracingIntegrator>>(m, "AttachedDiffPathtracingIntegrator")
        .def(pybind11::init(
               ...
               const uint32_t height)
            {
                ...
                atcg::ref_ptr<atcg::AttachedDiffPathtracingIntegrator> integrator =
                    atcg::make_ref<atcg::AttachedDiffPathtracingIntegrator>(context, dict);
                return integrator;
            }))
        .def("generateRays",
             [](const atcg::ref_ptr<atcg::AttachedDiffPathtracingIntegrator>& self)
             {
                 atcg::Dictionary dict;
        ...
        .def("generateRays",
             [](const atcg::ref_ptr<atcg::AttachedDiffPathtracingIntegrator>& self, uint32_t rng_index)
             {
                 atcg::Dictionary dict;
        ...
        .def("forwardTrace", &atcg::AttachedDiffPathtracingIntegrator::forwardTrace)
        .def("backwardTrace", &atcg::AttachedDiffPathtracingIntegrator::backwardTrace)
        .def("getAOVBuffer", &atcg::AttachedDiffPathtracingIntegrator::getAOVBuffer);
}