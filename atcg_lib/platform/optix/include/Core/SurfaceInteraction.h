...
struct Interaction
{
    ...
    ATCG_INLINE ATCG_HOST_DEVICE glm::mat3 getProjection() const
    {
        return glm::mat3(1.0f) - glm::outerProduct(reference_frame.localZ(), reference_frame.localZ());
    }
};
...
struct MediumInteraction : public Interaction
{
    ...
    ATCG_INLINE ATCG_HOST_DEVICE glm::mat3 getProjection() const { return glm::mat3(1.0f); }
};
...
struct DualMediumInteraction : public MediumInteraction
{
    ATCG_HOST_DEVICE DualMediumInteraction() : MediumInteraction() {}
...
struct AnyInteraction
{
    ...
    ATCG_INLINE ATCG_HOST_DEVICE AnyInteraction(const DualMediumInteraction &dmi)
    ...
    ATCG_INLINE ATCG_HOST_DEVICE operator DualMediumInteraction &() { return dmi; }
    ATCG_INLINE ATCG_HOST_DEVICE operator const DualMediumInteraction &() const { return dmi; }
    ...
    ATCG_INLINE ATCG_HOST_DEVICE bool is_dual_medium() const { return type == DualMediumInteractionType; }
    ...
    ATCG_INLINE ATCG_HOST_DEVICE AnyInteraction &operator=(const DualMediumInteraction &dmi)
    {
