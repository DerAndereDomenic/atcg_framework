...
void RendererSystem::Impl::setMaterial(const Material& material, const atcg::ref_ptr<Shader>& shader)
{
    ...
    material.getEmissiveTexture()->use(RendererSystem::Impl::TextureBindings::EMISSIVE_TEXTURE);
    shader->setInt("texture_emissive", RendererSystem::Impl::TextureBindings::EMISSIVE_TEXTURE);
