...
public:
     ...
     */
    ShaderBindingTable(ATCGDeviceContext context);
     ...
     */
    inline uint32_t addRaygenEntry(ATCGProgramGroup prog_group)
    {
     ...
     * @return The index of the entry into the SBT
     */
    inline uint32_t addMissEntry(ATCGProgramGroup prog_group)
    {
     ...
     * @return The index of the entry into the SBT
     */
    inline uint32_t addHitEntry(ATCGProgramGroup prog_group) { return addHitEntry(prog_group, std::vector<uint8_t>()); }
     ...
     * @return The index of the entry into the SBT
     */
    inline uint32_t addCallableEntry(ATCGProgramGroup prog_group)
    {
     ...
     */
    template<typename T>
    inline uint32_t addRaygenEntry(ATCGProgramGroup prog_group, const T& sbt_record_data)
    {
     ...
     */
    template<typename T>
    inline uint32_t addMissEntry(ATCGProgramGroup prog_group, const T& sbt_record_data)
    {
     ...
     */
    template<typename T>
    inline uint32_t addHitEntry(ATCGProgramGroup prog_group, const T& sbt_record_data)
    {
     ...
     */
    template<typename T>
    inline uint32_t addCallableEntry(ATCGProgramGroup prog_group, const T& sbt_record_data)
    {
     ...
     * @return The index of the entry into the SBT
     */
    uint32_t addRaygenEntry(ATCGProgramGroup prog_group, std::vector<uint8_t> sbt_record_custom_data);
     ...
     * @return The index of the entry into the SBT
     */
    uint32_t addMissEntry(ATCGProgramGroup prog_group, std::vector<uint8_t> sbt_record_custom_data);
     ...
     * @return The index of the entry into the SBT
     */
    uint32_t addHitEntry(ATCGProgramGroup prog_group, std::vector<uint8_t> sbt_record_custom_data);
     ...
     * @return The index of the entry into the SBT
     */
    uint32_t addCallableEntry(ATCGProgramGroup prog_group, std::vector<uint8_t> sbt_record_custom_data);
     ...
     */
    const ATCGShaderBindingTable getSBT(uint32_t raygen_index = 0) const;
