...
public:
     ...
     */
    RayTracingPipeline(ATCGDeviceContext context);
     ...
     */
    ATCGProgramGroup addRaygenShader(const ShaderEntryPointDesc& raygen_shader_desc);
     ...
     * @return The program group associated with the entry function
     */
    ATCGProgramGroup addCallableShader(const ShaderEntryPointDesc& callable_shader_desc);
     ...
     * @return The program group associated with the entry function
     */
    ATCGProgramGroup addMissShader(const ShaderEntryPointDesc& miss_shader_desc);
     ...
     * @return The program group associated with the entry function
     */
    ATCGProgramGroup addTrianglesHitGroupShader(const ShaderEntryPointDesc& closestHit_shader_desc,
     ...
     * @return The pipeline
     */
    ATCGPipeline getPipeline() const;
