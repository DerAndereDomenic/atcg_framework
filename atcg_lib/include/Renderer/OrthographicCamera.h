...
namespace atcg
{
    ...
    public:
         ...
         * @param top 
         */
        inline void setProjection(const float& left, const float& right, const float& bottom, const float& top) {_left = left; _right = right; _bottom = bottom; _top = top; recalculateProjection();}
