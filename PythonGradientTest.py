...
def estimate_gradient_fd(integrator: atcg.Integrator):
    ...
    roughness = bsdf.getParameter("roughness_texture")

    h = 0.001
    roughness_new = roughness + h
    bsdf.setParameter("roughness_texture", roughness_new)
    ...
    # Restore
    bsdf.setParameter("roughness_texture", roughness)
...
def main():
    ...
    axs[0, 0].set_title("Gradient of Image w.r.t. Roughness fd")
    axs[0, 0].axis("off")
    ...
    axs[1, 0].set_title("Gradient of Image w.r.t. Roughness prbp")
    axs[1, 0].axis("off")
    ...
    axs[1, 1].set_title("Gradient of Image w.r.t. Roughness atprbp")
    axs[1, 1].axis("off")
